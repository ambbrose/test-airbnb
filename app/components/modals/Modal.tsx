...
const Modal: React.FC<ModalProps> = ({
    ...
    return (
        <>
            <div className={`${!showModal && 'hidden'} justify-center items-center flex overflow-x-hidden overflow-y-auto fixed
                    inset-0 z-50 outline-none focus:outline-none bg-neutral-800/40`}
            >
